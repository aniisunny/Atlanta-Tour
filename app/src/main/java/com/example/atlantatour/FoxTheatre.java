...
public class FoxTheatre extends AppCompatActivity {

    private Intent intent;
    private String phoneNumber = "+1-404-881-2100";
    private String url = "https://www.foxtheatre.org/";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ChopsLobsterBarData data = new ChopsLobsterBarData(R.drawable.foxtheatre,
                "Fox Theatre", "660 Peachtree St NE, Atlanta, GA",
                "The fox Theatre is where everyone goes to see the hottest plays, " +
                        "concerts, speeches.", "The Fox Theatre, a former movie palace," +
                " is a performing arts venue located at 660 Peachtree Street NE in Midtown" +
                " Atlanta, Georgia, and is the centerpiece of the Fox Theatre Historic " +
                "District. The theater was originally planned as part of a large Shrine" +
                " Temple as evidenced by its Moorish design.");
            ...
            public void onClick(View v) {
                if(info.getText().equals("View More Info")) {
                    String text = "View Less Info<br><br><font color=#FFFFFF>" +
                            "(404) 881-2100<br>www.foxtheatre.org<\font>";
        ...
        call.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(FoxTheatre.this, "Call Button Clicked",
        ...
        web.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (intent.resolveActivity(getPackageManager()) != null)
                    startActivity(intent);
                Toast.makeText(FoxTheatre.this, "Web Button Clicked",
                        Toast.LENGTH_SHORT).show();
            }
        });
        ...
        map.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Uri location = Uri.parse("geo:33.772460, -84.385781");
                intent = new Intent(Intent.ACTION_VIEW);
                intent.setData(location);
                if (intent.resolveActivity(getPackageManager()) != null)
                    startActivity(intent);
                Toast.makeText(FoxTheatre.this, "Map Button Clicked",
                        Toast.LENGTH_SHORT).show();
            }
        });
        ...
        share.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra(Intent.EXTRA_SUBJECT, "Fox Theatre");
                intent.putExtra(Intent.EXTRA_TEXT, data.getName() + "\n" + data.getAddress() + "\n" + phoneNumber + "\n" + url);
                startActivity(Intent.createChooser(intent, "Share"));
                Toast.makeText(FoxTheatre.this, "Share Button Clicked",
                        Toast.LENGTH_SHORT).show();
            }
        });
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(textView.getText().equals("Save")) {
                    ...
                    Toast.makeText(FoxTheatre.this,
