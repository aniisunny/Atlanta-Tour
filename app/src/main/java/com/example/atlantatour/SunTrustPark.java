...
public class SunTrustPark extends AppCompatActivity {

    private Intent intent;
    private String phoneNumber = "+1-404-577-9100";
    private String url = "https://www.mlb.com/braves/ballpark";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ChopsLobsterBarData data = new ChopsLobsterBarData(R.drawable.suntrustpark,
                "Sun Trust Park", "755 Battery Ave SE, Atlanta, GA",
                ...
                "SunTrust Park is a baseball park located in the Atlanta metropolitan" +
                        " area 10 miles northwest of downtown Atlanta in the unincorporated" +
                        " community of Cumberland, in Cobb County, Georgia. It is the home" +
                        " ballpark of the Atlanta Braves of Major League Baseball.");
            ...
            public void onClick(View v) {
                if(info.getText().equals("View More Info")) {
                    String text = "View Less Info<br><br><font color=#FFFFFF>" +
                            "(404) 577-9100<br>www.mlb.com/braves/ballpark<\font>";
        ...
        call.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(SunTrustPark.this, "Call Button Clicked",
        ...
        web.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (intent.resolveActivity(getPackageManager()) != null)
                    startActivity(intent);
                Toast.makeText(SunTrustPark.this, "Web Button Clicked",
                        Toast.LENGTH_SHORT).show();
            }
        });
        ...
        map.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Uri location = Uri.parse("geo:33.890718, -84.467664");
                intent = new Intent(Intent.ACTION_VIEW);
                intent.setData(location);
                if (intent.resolveActivity(getPackageManager()) != null)
                    startActivity(intent);
                Toast.makeText(SunTrustPark.this, "Map Button Clicked",
                        Toast.LENGTH_SHORT).show();
            }
        });
        ...
        share.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra(Intent.EXTRA_SUBJECT, "Sun Trust Park");
                intent.putExtra(Intent.EXTRA_TEXT, data.getName() + "\n" + data.getAddress() + "\n" + phoneNumber + "\n" + url);
                startActivity(Intent.createChooser(intent, "Share"));
                Toast.makeText(SunTrustPark.this, "Share Button Clicked",
                        Toast.LENGTH_SHORT).show();
            }
        });
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(textView.getText().equals("Save")) {
                    ...
                    Toast.makeText(SunTrustPark.this,
